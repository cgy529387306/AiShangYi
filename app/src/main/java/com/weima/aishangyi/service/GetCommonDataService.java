...
public class GetCommonDataService extends Service{
    ...
    private void doGet(){
        ...
        RequestEntity entity = new RequestEntity.Builder().setTimeoutMs(30000).setUrl(ProjectConstants.Url.GET_COMMON_DATA)
        ...
        RequestHelper.post(entity, new ResponseListener() {
            ...
            public boolean onResponseSuccess(int gact, String response, Object... extras) {
                ServiceHelper.stopGetData();
                CommonDataResp entity = JsonHelper.fromJson(response, CommonDataResp.class);
                if ("200".equals(entity.getCode())) {
                    PreferencesHelper.getInstance().putString(ProjectConstants.Preferences.KEY_COMMON_DATA, response);
                } else {
