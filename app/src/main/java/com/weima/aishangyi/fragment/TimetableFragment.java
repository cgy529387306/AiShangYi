 ...
 * 联系人
 */
public class TimetableFragment extends Fragment implements XListView.IXListViewListener, ResponseListener {
    ...
    public static TimetableFragment newInstance(int type) {
    ...
    private void requestData(){
        ...
        post(ProjectConstants.Url.ORDER_MY_LESSON, requestMap);
    }
