...
public class TeacherListActivity extends BaseActivity implements View.OnClickListener, XListView.IXListViewListener {
    ...
    private void initUI() {
        ...
        if (Helper.isNotEmpty(className)){
            btn_filter_type.setText(className);
        }
    }
